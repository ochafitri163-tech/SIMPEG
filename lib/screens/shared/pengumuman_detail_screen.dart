...
/// Halaman Penuh (Full Screen) Detail Pengumuman untuk semua role
...
class _PengumumanDetailScreenState extends State<PengumumanDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = isDark ? const Color(0xFF10151C) : const Color(0xFFF3F6F9);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Salin Teks Pengumuman',
            onPressed: () {
              Clipboard.setData(ClipboardData(text: '${p.judul}\n\n$isiTampil'));
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Isi pengumuman berhasil disalin ke clipboard'),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  'Ketuk untuk membuka/mengunduh berkas',
                                  style: TextStyle(
                                    fontSize: 11,
